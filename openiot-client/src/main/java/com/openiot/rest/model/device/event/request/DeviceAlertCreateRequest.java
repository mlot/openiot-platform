...
public class DeviceAlertCreateRequest extends DeviceEventCreateRequest implements IDeviceAlertCreateRequest,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.openiot.spi.device.request.IDeviceAlertCreateRequest#getLevel()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.openiot.spi.device.request.IDeviceAlertCreateRequest#getType()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.openiot.spi.device.request.IDeviceAlertCreateRequest#getMessage()
	 */
