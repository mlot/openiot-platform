 ...
 * @author Derek Adams
 */
public class OpenIoTSystemException extends OpenIoTException {
	...
	public OpenIoTSystemException(ErrorCode code, ErrorLevel level) {
		this(code, null, level);
	}

	public OpenIoTSystemException(ErrorCode code, ErrorLevel level, int httpResponseCode) {
		this(code, null, level);
		setHttpResponseCode(httpResponseCode);
	}

	public OpenIoTSystemException(ErrorCode code, Throwable cause, ErrorLevel level) {
