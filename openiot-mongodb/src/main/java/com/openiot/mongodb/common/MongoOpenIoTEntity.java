 ...
 * LICENSE.txt file.
 */
package com.openiot.mongodb.common;

import com.mongodb.BasicDBObject;
import com.mongodb.DBObject;
import com.openiot.rest.model.common.MetadataProviderEntity;
import com.openiot.spi.common.IOpenIoTEntity;

import java.util.Date;

/**
 * Used to load or save OpenIoTEntity data to MongoDB.
 * 
 * @author dadams
 */
public class MongoOpenIoTEntity {
	 ...
	 * @param target
	 */
	public static void toDBObject(IOpenIoTEntity source, BasicDBObject target) {
