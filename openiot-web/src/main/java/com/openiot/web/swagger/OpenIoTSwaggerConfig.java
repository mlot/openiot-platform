...
@Configuration
@EnableSwagger
public class OpenIoTSwaggerConfig {

	/** Title for API page */
	private static final String API_TITLE = "OpenIoT REST APIs";

	/** Description for API page */
	private static final String API_DESCRIPTION =
			"Operations that allow remote clients to interact with the core OpenIoT data model.";

	/** Contact email for API questions */
	private static final String API_CONTACT_EMAIL = "";
	...
	private static final String API_LICENSE_URL =
			"https://github.com/openiot/openiot/blob/master/LICENSE.txt";

	/** Swagger configuration */
	private SpringSwaggerConfig springSwaggerConfig;

	/** OpenIoT path provider */
	private OpenIoTPathProvider pathProvider;
	...
	public void setServletContext(ServletContext servletContext) {
		this.pathProvider = new OpenIoTPathProvider(servletContext);
	}
