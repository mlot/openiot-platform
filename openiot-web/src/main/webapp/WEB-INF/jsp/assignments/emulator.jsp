				...
				<div>
					<form class="form-horizontal" style="padding-top: 20px; display: inline-block; vertical-align: top">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="mqtt-client-id" value="OpenIoTWeb"
									class="input-large">
							</div>
						</div>
					</form>
					<form class="form-horizontal" style="padding-top: 20px; display: inline-block; vertical-align: top">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="mqtt-topic" class="input-large" value="OpenIoT/input/jsonbatch">
							</div>
						</div>
					</form>
				</div>
...
<script>
	...
	function initMap() {
		...
		locationsLayer = L.FeatureGroup.OpenIoT.assignmentLocations({
