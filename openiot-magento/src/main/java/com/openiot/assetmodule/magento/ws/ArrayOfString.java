 ...
 *       &lt;sequence>
 *         &lt;element name="complexObjectArray" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfString {
    ...
    protected List<String> complexObjectArray;
     ...
     * 
     */
    public List<String> getComplexObjectArray() {
        if (complexObjectArray == null) {
            complexObjectArray = new ArrayList<String>();
        }
