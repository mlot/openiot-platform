...
/**
 * <p>Java class for shoppingCartProductResponseEntityArray complex type.
 * 
...
@XmlType(name = "shoppingCartProductResponseEntityArray", propOrder = {
    "complexObjectArray"
})
public class ShoppingCartProductResponseEntityArray {
