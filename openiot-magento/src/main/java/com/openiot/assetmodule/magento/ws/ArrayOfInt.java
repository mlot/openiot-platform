 ...
 *       &lt;sequence>
 *         &lt;element name="complexObjectArray" type="{http://www.w3.org/2001/XMLSchema}int" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfInt {
    ...
    protected List<Integer> complexObjectArray;
     ...
     * 
     */
    public List<Integer> getComplexObjectArray() {
        if (complexObjectArray == null) {
            complexObjectArray = new ArrayList<Integer>();
        }
