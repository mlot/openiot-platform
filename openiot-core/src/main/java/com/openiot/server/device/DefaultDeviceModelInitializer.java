...
import com.openiot.server.asset.filesystem.FileSystemDeviceAssetModule;
import com.openiot.server.asset.filesystem.FileSystemHardwareAssetModule;
import com.openiot.server.asset.filesystem.FileSystemLocationAssetModule;
import com.openiot.server.asset.filesystem.FileSystemPersonAssetModule;
...
public class DefaultDeviceModelInitializer implements IDeviceModelInitializer {
	 ...
	 * 
	 * @see
	 * IDeviceModelInitializer#initialize(com.openiot
	 ...
	 */
	protected void testListAndRemoveNetworkElements(IDeviceGroup group) throws OpenIoTException {
	 ...
	 * @throws com.openiot.spi.OpenIoTException
	 */
	public IDeviceSpecification[] createDeviceSpecifications() throws OpenIoTException {
	 ...
	 * @throws com.openiot.spi.OpenIoTException
	 */
	public void createDeviceCommands(IDeviceSpecification spec) throws OpenIoTException {
	 ...
	 * @throws com.openiot.spi.OpenIoTException
	 */
	public List<ISite> createSites() throws OpenIoTException {
	 ...
	 * @throws com.openiot.spi.OpenIoTException
	 */
	public IZone createZone(ISite site) throws OpenIoTException {
	...
	public IDeviceGroup createHeavyEquipmentGroup() throws OpenIoTException {
	...
	public IDeviceGroup createPersonnelTrackingGroup() throws OpenIoTException {
		DeviceGroupCreateRequest request = new DeviceGroupCreateRequest();
		request.setToken(UUID.randomUUID().toString());
	...
	public IDeviceGroup createToolTrackingGroup() throws OpenIoTException {
		DeviceGroupCreateRequest request = new DeviceGroupCreateRequest();
		request.setToken(UUID.randomUUID().toString());
	...
	public List<DeviceAssignment> createAssignments(ISite site, Map<String, SpecificationDetails> specMap)
		...
		for (int x = 0; x < ASSIGNMENTS_PER_SITE; x++) {
			...
			results.add(helper.convert(assignment, OpenIoT.getServer().getAssetModuleManager()));
		}
		return results;
	}
	...
	protected List<IDeviceCommandInvocation> createDeviceCommandInvocations(IDeviceAssignment assignment,
			Date date, List<IDeviceCommand> commands) throws OpenIoTException {
		long current = date.getTime();
	...
	protected List<IDeviceCommandResponse> createDeviceCommandResponses(IDeviceAssignment assignment,
			Date date, List<IDeviceCommandInvocation> invocations) throws OpenIoTException {
		long current = date.getTime();
	...
	protected List<IDeviceStateChange> createDeviceStateChanges(IDeviceAssignment assignment,
			IDeviceSpecification specification, Date start) throws OpenIoTException {
