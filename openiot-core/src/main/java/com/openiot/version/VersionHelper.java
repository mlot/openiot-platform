...
public class VersionHelper {
	...
	private static final String CE_CLASSNAME = "com.openiot.Version";

	/** Classname for Enterprise Edition version information */
	private static final String EE_CLASSNAME = "com.openiot.ee.Version";
