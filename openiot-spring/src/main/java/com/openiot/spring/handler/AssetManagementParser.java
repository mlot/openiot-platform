...
import com.openiot.server.asset.AssetModuleManager;
...
/**
 * Parses configuration data for the OpenIoT asset management section.
 * 
 * @author Derek
 */
public class AssetManagementParser extends AbstractBeanDefinitionParser {
	...
	protected AbstractBeanDefinition parseInternal(Element element, ParserContext context) {
		...
		context.getRegistry().registerBeanDefinition(OpenIoTServerBeans.BEAN_ASSET_MODULE_MANAGER,
