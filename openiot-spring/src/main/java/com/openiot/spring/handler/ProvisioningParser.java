...
import com.openiot.device.provisioning.DefaultDeviceProvisioning;
...
/**
 * Parses configuration data from OpenIoT provisioning section.
 * 
 * @author Derek
 */
public class ProvisioningParser extends AbstractBeanDefinitionParser {
	...
	protected AbstractBeanDefinition parseInternal(Element element, ParserContext context) {
		...
		context.getRegistry().registerBeanDefinition(OpenIoTServerBeans.BEAN_DEVICE_PROVISIONING,
