...
import com.openiot.device.event.processor.DefaultEventStorageProcessor;
import com.openiot.device.event.processor.DefaultInboundEventProcessorChain;
...
/**
 * Parses configuration data from OpenIoT inbound processing chain section.
 * 
 * @author Derek
 */
public class InboundProcessingChainParser extends AbstractBeanDefinitionParser {
	...
	protected AbstractBeanDefinition parseInternal(Element element, ParserContext context) {
		...
		context.getRegistry().registerBeanDefinition(OpenIoTServerBeans.BEAN_INBOUND_PROCESSOR_CHAIN,
