...
import com.openiot.device.provisioning.mqtt.HardwareIdMqttParameterExtractor;
import com.openiot.device.provisioning.mqtt.MqttCommandDeliveryProvider;
import com.openiot.device.provisioning.mqtt.MqttCommandDestination;
import com.openiot.device.provisioning.mqtt.MqttParameters;
import com.openiot.device.provisioning.protobuf.JavaHybridProtobufExecutionEncoder;
import com.openiot.device.provisioning.protobuf.ProtobufExecutionEncoder;
import com.openiot.device.provisioning.sms.SmsCommandDestination;
...
public class CommandDestinationsParser {
	...
	protected AbstractBeanDefinition createTwilioDeliveryProvider(Element element) {
		BeanDefinitionBuilder twilio =
				BeanDefinitionBuilder.rootBeanDefinition("com.openiot.twilio.TwilioCommandDeliveryProvider");
	...
	/**
	 * Parse definition of OpenIoT GPB command encoder.
	 * 
	 * @param encoder
	 * @param context
	 * @param destination
	...
	/**
	 * Parse definition of OpenIoT Java/GPB hybrid command encoder.
	 * 
	 * @param encoder
	 * @param context
	 * @param destination
	...
	public static enum BinaryCommandEncoders {
		...
		/** Encodes commands with standard OpenIoT GPB naming convention */
